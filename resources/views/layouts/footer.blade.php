<footer class="d-flex flex-wrap justify-content-between align-items-center border-top">
    <div class="col-12 col-sm-8 d-flex align-items-center ps-3">
        <span class="mb-3 mb-sm-0 text-muted">Copyright &copy; App created by Liant and Goldy for Kejaksaan
            Tinggi Jawa
            Timur</span>
    </div>
